...
- **POST /api/images/register**
  ...
  - **Resposta**:
    - **Status 200 OK**: Retorna os dados do usuário registrado.
...
- **POST /api/images/login**
  ...
  - **Resposta**:
    - **Status 200 OK**: Retorna uma mensagem de sucesso.
...
curl -X POST http://localhost:8080/api/images/register -H "Content-Type: application/json" -d '{
  "username": "john_doe",
...
##### Login de Usuário
curl -X POST http://localhost:8080/api/images/login -H "Content-Type: application/json" -d '{
  "username": "john_doe",
  "password": "secure_password"
}'

##### Visualização de Perfil
curl -X GET http://localhost:8080/api/images/profile -H "Authorization: Bearer <token>"

##### Geração de Imagem
curl -X POST http://localhost:8080/api/images/generateImage -H "Content-Type: text/plain" -d 'Uma bela paisagem'

##### Geração de Texto
curl -X POST http://localhost:8080/api/images/generate -H "Content-Type: text/plain" -d 'Escreva um poema sobre a natureza'
